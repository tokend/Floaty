...
open class Floaty: UIView {
    ...
    open override func draw(_ rect: CGRect) {
        ...
        if buttonImage == nil {
            ...
            setPlusLayer()
            self.plusLayer.strokeColor = UIColor.clear.cgColor
            setButtonImage()
        }
        setShadow()
    }
        ...
        if(items.count > 0){
            ...
            UIView.animate(withDuration: 0.3, delay: 0,
                           ...
                           options: UIView.AnimationOptions(), animations: { () -> Void in
                            ...
                            self.plusLayer.strokeColor = UIColor.white.cgColor
        ...
        if(items.count > 0){
            ...
            UIView.animate(withDuration: 0.1, delay: 0,
                           ...
                           options: [], animations: { () -> Void in
                            ...
                            self.plusLayer.strokeColor = UIColor.clear.cgColor
                            self.plusLayer.transform = CATransform3DMakeScale(-0.1, -0.1, -0.1)
            }, completion: nil)
